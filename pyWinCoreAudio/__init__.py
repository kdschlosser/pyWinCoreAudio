...
from .__core_audio.mmdeviceapi import IMMDeviceEnumerator
...
#
# AudioDevice = _device.AudioDevice
# AudioDeviceEnumerator = _device.AudioDeviceEnumerator
# AudioNotificationClient = _device.AudioNotificationClient
#
# AudioDefaultEndpoint = _endpoint.AudioDefaultEndpoint
#
#
...
#         endpoint = self.__device_enum.default_endpoint(EDataFlow.eRender)
#
...
#         endpoint = self.__device_enum.default_endpoint(EDataFlow.eCapture)
#
#         device_topology = comtypes.cast(
#             endpoint.Activate(
#                 IID_IDeviceTopology,
